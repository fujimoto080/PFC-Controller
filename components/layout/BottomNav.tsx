...
import { Home, PlusCircle, History, Calendar, Utensils } from 'lucide-react';
...
export function BottomNav() {
  ...
  return (
    <nav className="bg-background/80 pb-safe fixed right-0 bottom-0 left-0 z-50 border-t backdrop-blur-lg">
